...
#ifndef VERILATED_VRAM_32X8___024ROOT_H_
#define VERILATED_VRAM_32X8___024ROOT_H_  // guard

#include "verilated.h"

class Vram_32x8__Syms;

class Vram_32x8___024root final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vram_32x8___024root(Vram_32x8__Syms* symsp, const char* v__name);
    ~Vram_32x8___024root();
    VL_UNCOPYABLE(Vram_32x8___024root);
