...
typedef struct {
    ...
    unsigned long long I970;
    unsigned long long I957;
    U  I956;
    U  I971;
    U  I972;
    U  I973;
...
typedef struct {
    U  I714;
    U  I722;
    RmaThreadSchedCompiledLoads  * I1015;
...
typedef struct TableAssignLayoutOnClkOpt_ {
    ...
    U  I1088 :1;
    U  I904 :13;
    RmaSeqPrimOutputOnClkOpt  I1090;
    RmaSeqPrimOutputEblkData  I1094;
...
struct dummyq_struct {
    ...
    struct futq * I1189;
    struct futq * I1190;
    struct sched_table * I1191;
    struct futq_info * I1193;
    struct futq_info * I1195;
    U  I1196;
    U  I1197;
    U  I1198;
    U  I1199;
    ...
    int I1256;
    int I1257;
    struct vcs_globals_t * I1258;
    clock_struct  I1259;
    unsigned long long I1260;
    EBLK  * I1261;
    EBLK  * I1262;
    void * I1263;
};
...
void  hs_0_M_0_1__simv_daidir (UB  * pcode, scalar  val, U  I677, scalar  * I1304, U  did);
